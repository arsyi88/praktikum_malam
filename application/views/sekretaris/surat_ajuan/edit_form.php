<main>
    <div class="container-fluid">
        ...
        <div class="card mb-4">
            <div class="card-body">
                <form action="<?php echo site_url('sekretaris/surat_ajuan/edit') ?>" method="post" enctype="multipart/form-data">
                    <div class="mb-3">
                        <label>NO SURAT <code>*</code></label>
                        <input class="form-control" type="hidden" name="id" value="<?=$surat->id;?>" required />
                        <input class="form-control" type="text" name="no_surat" value="<?=$surat->no_surat;?>" placeholder="NO SURAT MASUK PENGAJUAN" disabled required />
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="card text-dark bg-light mb-3" style="max-width: 40rem;">
                        ...
                        <div class="card-body">
                            <img src="<?php echo base_url();?>assets/photo/surat_ajuan/<?php echo $surat->image;?>" class="card-img" width ='500'>
                        </div>
                    </div>
                    <div class="mb-3">
