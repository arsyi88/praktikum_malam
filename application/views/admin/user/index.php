                                ...
                                echo "<tr>
                                    ...
                                    <td>
                                        <div>
                                            ...
                                            <a href=".base_url('admin/user/delete/' . $userData->id)." class='btn btn-sm btn-danger' onclick='return confirm(\"Ingin menghapus data user ini?\");'><i class='fas fa-trash'></i> Hapus</a>
                                        </div>
                                    </td>
                                </tr>";
                                $no++;
